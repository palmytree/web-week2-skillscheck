...
const faveColors = ['darkgreen', 'limegreen', 'black']
...
const me = {
    firstName: 'Jeff',
    superHeroName: 'Palmy Palm',
    homeTown: 'Dallas',
    superPowers: ['Palmy Positivity', 'Troll Neutralizer', 'Killer Kindness'],
